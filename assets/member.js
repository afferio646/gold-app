    ...
    document.getElementById('modal-content').innerHTML = `
        ...
        <div class="border-t-4 border-gray-200 pt-8 break-inside-avoid">
            ...
            <div class="space-y-6 text-sm text-gray-700 leading-relaxed">
                ...
                <div class="html2pdf__page-break" style="page-break-before: always; height: 1px; display: block; clear: both; margin: 0; padding: 0;"></div>
...
async function uploadReport() {
    ...
    const fileName = `member_report_${cleanName}_${Date.now()}.pdf`;
    ...
    try {
        ...
        if (pdfUrl) {
            // Update the lead record with the PDF URL
